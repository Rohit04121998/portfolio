...
import profilePic from "../assets/RVProfile.png"
            ...
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    <motion.h1 
                        ...
                        className='pb-16 text-6xl font-extrabold tracking-tight lg:mt-16 lg:text-8xl'>Rohit Veeradhi
                    </motion.h1>
                    <motion.span 
            ...
            <div className='w-full lg:w-1/2 lg:p-8'>
                <div className='flex justify-center'>
                    <motion.img initial={{x: 100, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{duration: 1, delay: 1.2}}
                        className="rounded-2xl" src={profilePic}  width={600} height={600} alt='Rohit Veeradhi' 
                    />
                </div>
            </div>
        </div>
