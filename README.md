...
A modern portfolio built using React.js and Tailwind.
...
👉 **Hero**: Captivating introduction featuring a smooth animation.

👉 **Work Experience**: Prominent display of professional background for emphasis and credibility.

👉 **Contact Form**: Seamless API integration with user interaction tracking and dynamic feedback messages.
...
```bash
git clone https://github.com/Rohit04121998/portfolio.git
cd portfolio
```
